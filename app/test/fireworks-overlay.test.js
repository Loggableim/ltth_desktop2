...
describe('Fireworks Overlay Transparency', () => {
    ...
    test('should have html element with transparent background', () => {
        expect(overlayContent).toMatch(/html\s*{[^}]*background:\s*transparent\s*!important/);
        expect(overlayContent).toMatch(/html\s*{[^}]*background-color:\s*transparent\s*!important/);
    });
    
    test('should have body element with transparent background', () => {
        expect(overlayContent).toMatch(/body\s*{[^}]*background:\s*transparent\s*!important/);
        expect(overlayContent).toMatch(/body\s*{[^}]*background-color:\s*transparent\s*!important/);
    });
    
    test('should have container with transparent background', () => {
        expect(overlayContent).toMatch(/#fireworks-container\s*{[^}]*background:\s*transparent\s*!important/);
        expect(overlayContent).toMatch(/#fireworks-container\s*{[^}]*background-color:\s*transparent\s*!important/);
    });
    ...
    test('should have canvas with transparent background', () => {
        expect(overlayContent).toMatch(/#fireworks-canvas\s*{[^}]*background:\s*transparent\s*!important/);
        expect(overlayContent).toMatch(/#fireworks-canvas\s*{[^}]*background-color:\s*transparent\s*!important/);
    });
