...
function calculateWindForce() {
    ...
    // Increased multiplier from 0.01 to 0.2 for noticeable wind effect
    // Wind strength 50 = 0.1, 100 = 0.2
    // This provides enough force to visibly affect emoji movement
    const maxWindForce = (config.wind_strength / 100) * 0.2;
