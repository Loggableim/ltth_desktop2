...
class GoalsWebSocket {
    ...
    broadcastGoalValueChanged(goal) {
        ...
        // FIX: Broadcast globally to all connected clients
        // This ensures both UI and overlays receive the update exactly once
        // Overlays filter by goalId, so they only process relevant events
        this.io.emit('goals:value-changed', payload);
    }
